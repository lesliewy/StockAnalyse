...
DELETE FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161227%';
DELETE FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-12-27%';
DELETE FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-12-27%';
DELETE FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-12-27%';
DELETE FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-12-27%';
DELETE FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-12-27%';

SELECT * FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161227%';
SELECT COUNT(*) FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-12-27%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-12-27%';
SELECT COUNT(*) FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-12-27%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-12-27%';
SELECT COUNT(*) FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-12-27%';
-- END JOB T.
