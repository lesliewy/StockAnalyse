...
DELETE FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161026%';
DELETE FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-26%';
DELETE FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-26%';
DELETE FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-26%';
DELETE FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-26%';
DELETE FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-10-26%';

SELECT * FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161026%';
SELECT COUNT(*) FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-26%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-26%';
SELECT COUNT(*) FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-26%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-26%';
SELECT COUNT(*) FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-10-26%';
-- END JOB T.
