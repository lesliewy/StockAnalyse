...
DELETE FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161024%';
DELETE FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-24%';
DELETE FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-24%';
DELETE FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-24%';
DELETE FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-24%';
DELETE FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-10-24%';

SELECT * FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '161024%';
SELECT COUNT(*) FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-24%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2016-10-24%';
SELECT COUNT(*) FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-24%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2016-10-24%';
SELECT COUNT(*) FROM ST_INDEX WHERE TRADE_DATE LIKE '2016-10-24%';
-- END JOB T.
