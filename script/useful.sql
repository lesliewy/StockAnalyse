...
DELETE FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '170103%';
DELETE FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2017-01-03%';
DELETE FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2017-01-03%';
DELETE FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2017-01-03%';
DELETE FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2017-01-03%';
DELETE FROM ST_INDEX WHERE TRADE_DATE LIKE '2017-01-03%';

SELECT * FROM ST_JOB WHERE JOB_TYPE='T' AND JOB_DATE LIKE '170103%';
SELECT COUNT(*) FROM ST_NOTION_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2017-01-03%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT WHERE SOURCE='THS' AND TRADE_DATE LIKE '2017-01-03%';
SELECT COUNT(*) FROM ST_NOTION_HOT_STOCKS WHERE TRADE_DATE LIKE '2017-01-03%';
SELECT COUNT(*) FROM ST_INDUSTRY_HOT_STOCKS WHERE TRADE_DATE LIKE '2017-01-03%';
SELECT COUNT(*) FROM ST_INDEX WHERE TRADE_DATE LIKE '2017-01-03%';
-- END JOB T.
